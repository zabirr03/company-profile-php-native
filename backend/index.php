...
// @ berfungsi untuk penghilang notice erorr
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <!-- ini menggunakan htaccess -->
            <a class="nav-link " href="edit_about" >
                    <i class="	fas fa-user-alt"></i>
                    <span>About</span>
                </a>
                    <!-- untuk link ini menggunakan htaccess -->
                <a class="nav-link " href="tampil_produk" >
                     <i class="fas fa-box"></i>
                    <span>Produk</span>
                </a>
                <!-- untuk link ini menggunakan htaccess -->
                <a class="nav-link " href="tampil_berita" >
                    <i class="fas fa-newspaper"></i>
                    <span>Berita</span>
                </a>
                <!-- untuk link ini menggunakan htaccess -->
                <a class="nav-link " href="tampil_galeri" >
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Rizki Mahendra 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Apa Anda Yakin Mau Keluar</div>
